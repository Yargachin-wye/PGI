...
#define FILE_PATH_PIC_IN    "res/Lake.bmp"
#define FILE_PATH_TXT_IN    "res/sing_in.txt"
#define FILE_PATH_PIC_OUT   "res/LakeOut.bmp"
#define FILE_PATH_TXT_OUT   "res/sing_out.txt"

void Steganography::Run()
{
